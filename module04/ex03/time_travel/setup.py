...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'fixed_frame_tf2_broadcaster = time_travel.fixed_frame_tf2_broadcaster:main',
            'dynamic_frame_tf2_broadcaster = time_travel.dynamic_frame_tf2_broadcaster:main',
            'carrot_broadcaster = time_travel.carrot_broadcaster:main',
        ],
    },
)
